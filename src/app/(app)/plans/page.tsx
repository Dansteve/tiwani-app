...
// wrap it: an unauthenticated caller is sent to /sign-in. The list reads GET /api/v3/plans and renders
// the api's PlanSummary rows; opening a plan re-reads GET /api/v3/plans/{activity_id} and re-renders it
